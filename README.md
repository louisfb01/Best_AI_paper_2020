...
- [PULSE: Self-Supervised Photo Upsampling via Latent Space Exploration of Generative Models [3]](#3)
- [Unsupervised Translation of Programming Languages [4]](#4)
- [PIFuHD: Multi-Level Pixel-Aligned Implicit Function for High-Resolution 3D Human Digitization [5]](#5)
- [High-Resolution Neural Face Swapping for Visual Effects [6]](#6)
- [Swapping Autoencoder for Deep Image Manipulation [7]](#7)
- [GPT-3: Language Models are Few-Shot Learners [8]](#8)
- [Learning Joint Spatial-Temporal Transformations for Video Inpainting [9]](#9)
- [Image GPT - Generative Pretraining from Pixels [10]](#10)
- [Learning to Cartoonize Using White-box Cartoon Representations [11]](#11)
- [FreezeG: Freeze the Discriminator: a Simple Baseline for Fine-Tuning GANs [12]](#12)
- [Neural Re-Rendering of Humans from a Single Image [13]](#13)
...
- [Beyond the Nav-Graph: Vision-and-Language Navigation in Continuous Environments [15]](#15)
- [RAFT: Recurrent All-Pairs Field Transforms for Optical Flow [16]](#16)
- [Crowdsampling the Plenoptic Function [17]](#17)
- [Old Photo Restoration via Deep Latent Space Translation [18]](#18)
- [Neural circuit policies enabling auditable autonomy [19]](#19)
- [Lifespan Age Transformation Synthesis [20]](#20)
- [DeOldify](#extra1)
- [COOT: Cooperative Hierarchical Transformer for Video-Text Representation Learning [21]](#21)
...
](https://youtu.be/CtjZFkO5RPw) - Short Video Explanation
...
* [AI Generates Real Faces From Sketches! DeepFaceDrawing Overview | Image-to-image translation in 2020](https://youtu.be/djXdgCVB0oM) - Short Video Explanation
...
## PULSE: Self-Supervised Photo Upsampling via Latent Space Exploration of Generative Models [3]<a name="3"></a>
...
* [This AI makes blurry faces look 60 times sharper! Introduction to PULSE: photo upsampling](https://youtu.be/cgakyOI9r8M) - Short Video Explanation
...
## Unsupervised Translation of Programming Languages [4]<a name="4"></a>
...
* [This AI translates code from a programming language to another | Facebook TransCoder Explained](https://youtu.be/u6kM2lkrGQk) - Short Video Explanation
...
## PIFuHD: Multi-Level Pixel-Aligned Implicit Function for High-Resolution 3D Human Digitization [5]<a name="5"></a>
...
* [AI Generates 3D high-resolution reconstructions of people from 2D images | Introduction to PIFuHD](https://youtu.be/ajWtdm05-6g) - Short Video Explanation
...
## High-Resolution Neural Face Swapping for Visual Effects [6]<a name="6"></a>
...
* [Disney's New High Resolution Face Swapping Algorithm | New 2020 Face Swap Technology Explained](https://youtu.be/EzyhA46DQWA) - Short Video Explanation
...
## Swapping Autoencoder for Deep Image Manipulation [7]<a name="7"></a>
...
* [Texture-Swapping AI beats GANs for Image Manipulation! New Technique: Swapping Autoencoder Explained](https://youtu.be/hPR4cRzQY0s) - Short Video Explanation
...
## GPT-3: Language Models are Few-Shot Learners [8]<a name="8"></a>
...
* [OpenAI's New Language Generator: GPT-3 | This AI Generates Code, Websites, Songs & More From Words](https://youtu.be/gDDnTZchKec) - Short Video Explanation
...
## Learning Joint Spatial-Temporal Transformations for Video Inpainting [9]<a name="9"></a>
...
* [This AI Takes a Video and Fills the Missing Pixels Behind an Object ! Video Inpainting](https://youtu.be/MAxMYGoN5U0) - Short Video Explanation
...
## Image GPT - Generative Pretraining from Pixels [10]<a name="10"></a>
...
* [This AI Can Generate the Other Half of a Picture Using a GPT Model](https://youtu.be/FwXQ568_io0) - Short Video Explanation
...
## Learning to Cartoonize Using White-box Cartoon Representations [11]<a name="11"></a>
...
* [This AI can cartoonize any picture or video you feed it! Paper Introduction & Results examples](https://youtu.be/GZVsONq3qtg) - Short Video Explanation
...
## FreezeG: Freeze the Discriminator: a Simple Baseline for Fine-Tuning GANs [12]<a name="12"></a>
...
* [This Face Generating Model Transfers Real Face Photographs Into Distinctive Cartoon Styles | FreezeG](https://youtu.be/RvPUVniQiuw) - Short Video Explanation
...
## Neural Re-Rendering of Humans from a Single Image [13]<a name="13"></a>
...
* [Transfer clothes between photos using AI. From a single image!](https://youtu.be/E7fGsSNKMc4) - Short Video Explanation
...
## I2L-MeshNet: Image-to-Lixel Prediction Network for Accurate 3D Human Pose and Mesh Estimation from a Single RGB Image [14]<a name="14"></a>
DescHere
* [Accurate 3D Human Pose and Mesh Estimation from a Single RGB Image! With Code Publicly Avaibable!](https://youtu.be/tDz2wTixcrI) - Short Video Explanation
...
## Beyond the Nav-Graph: Vision-and-Language Navigation in Continuous Environments [15]<a name="15"></a>
...
* [Language-Guided Navigation in 3D Environment | Facebook AI Research (with code publicly available!)](https://youtu.be/Fw_RUlUjuN4) - Short Video Explanation
...
## RAFT: Recurrent All-Pairs Field Transforms for Optical Flow [16]<a name="16"></a>
...
* [ECCV 2020 Best Paper Award | RAFT: A New Deep Network Architecture For Optical Flow | WITH CODE](https://youtu.be/OSEuYBwOSGI) - Short Video Explanation
...
## Crowdsampling the Plenoptic Function [17]<a name="17"></a>
...
* [Reconstruct photorealistic scenes from tourists public photos on the internet!](https://youtu.be/F_JqJNBvJ64) - Short Video Explanation
...
## Old Photo Restoration via Deep Latent Space Translation [18]<a name="18"></a>
...
* [Old Photo Restoration Using Deep Learning | 2020 Novel Approach Explained & Results](https://youtu.be/QUmrIpl0afQ) - Short Video Explanation
...
## Neural circuit policies enabling auditable autonomy [19]<a name="19"></a>
...
* [A new brain-inspired intelligent system can drive a car using only 19 control neurons!](https://youtu.be/wAa358pNDkQ) - Short Video Explanation
...
## Lifespan Age Transformation Synthesis [20]<a name="20"></a>
...
* [Lifespan Age Transformation Synthesis | Generate Younger & Older Versions of Yourself !](https://youtu.be/xA-3cWJ4Y9Q) - Short Video Explanation
...
* [This AI can Colorize your Black & White Photos with Full Photorealistic Renders! (DeOldify)](https://youtu.be/1EP_Lq04h4M) - Short Video Explanation
...
## COOT: Cooperative Hierarchical Transformer for Video-Text Representation Learning [21]<a name="21"></a>
...
* [Video to Text Description Using Deep Learning and Transformers | COOT](https://youtu.be/5TRp5SuEtoY) - Short Video Explanation
...
## Stylized Neural Painting [22]<a name="22"></a>
...
* [Image-to-Painting Translation With Style Transfer](https://youtu.be/dzJStceOaQs) - Short Video Explanation
...
## Is a Green Screen Really Necessary for Real-Time Portrait Matting? [23]<a name="23"></a>
...
* [High-Quality Background Removal Without Green Screens | State of the Art Approach Explained](https://youtu.be/rUo0wuVyefU) - Short Video Explanation
...
## ADA: Training Generative Adversarial Networks with Limited Data [24]<a name="24"></a>
...
* [GAN Training Breakthrough for Limited Data Applications & New NVIDIA Program! NVIDIA Research](https://youtu.be/9fVNtVr_luc) - Short Video Explanation
...
[8] T. B. Brown, B. Mann, N. Ryder, M. Subbiah, J. Kaplan, P. Dhariwal, A. Neelakantan, P.Shyam, G. Sastry, A. Askell, S. Agarwal, A. Herbert-Voss, G. Krueger, T. Henighan, R. Child, A. Ramesh, D. M. Ziegler, J. Wu, C. Winter, C. Hesse, M. Chen, E. Sigler, M. 
Litwin, S.Gray, B. Chess, J. Clark, C. Berner, S. McCandlish, A. Radford, I. Sutskever, and D. Amodei,"Language models are few-shot learners," 2020. arXiv:2005.14165 [cs.CL].
